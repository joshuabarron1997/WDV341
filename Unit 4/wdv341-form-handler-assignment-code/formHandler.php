...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inStudent = $_POST["fullStudent"]; //Get the Value entered in the student checkbox
	$inColor = $_POST["color"]; // get value entered in the color radio list
	$inBookClub = $_POST["bookClub"]; // get the value in the book club checkbox
	$inMovieClub = $_POST["movieClub"]; //get the value in the movie club checkbox
	$inFruit = $_POST["favoriteFruit"]; // get the value in the favorite fruit drop down list
	$inEmail = $_POST["email"]; // grabs the honeypot value
...
<p>Student: <?php echo $inStudent;?></p>
<p>Favorite Color: <?php echo $inColor;?></p>
<p>Active Clubs: <br>
	Book Club = <?php echo $inBookClub . "<br>";?>
	Movie Club = <?php echo $inMovieClub;?>
</p>
<p>Favorite Fruit: <?php echo $inFruit;?></p>
<p>Email (Honey Pot): <?php echo $inEmail?></p>
</body>
</html>
